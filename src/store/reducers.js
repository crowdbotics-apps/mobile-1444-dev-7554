...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_DATA_MODEL_LIST:
    case types.API_V1_DATA_MODEL_LIST_SUCCEEDED:
    case types.API_V1_DATA_MODEL_LIST_FAILED:
    case types.API_V1_DATA_MODEL_CREATE:
    case types.API_V1_DATA_MODEL_CREATE_SUCCEEDED:
    case types.API_V1_DATA_MODEL_CREATE_FAILED:
    case types.API_V1_DATA_MODEL_READ:
    case types.API_V1_DATA_MODEL_READ_SUCCEEDED:
    case types.API_V1_DATA_MODEL_READ_FAILED:
    case types.API_V1_DATA_MODEL_UPDATE:
    case types.API_V1_DATA_MODEL_UPDATE_SUCCEEDED:
    case types.API_V1_DATA_MODEL_UPDATE_FAILED:
    case types.API_V1_DATA_MODEL_PARTIAL_UPDATE:
    case types.API_V1_DATA_MODEL_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_DATA_MODEL_PARTIAL_UPDATE_FAILED:
    case types.API_V1_DATA_MODEL_DELETE:
    case types.API_V1_DATA_MODEL_DELETE_SUCCEEDED:
    case types.API_V1_DATA_MODEL_DELETE_FAILED:
