...
export const api_v1_data_model_list = () => ({
  type: types.API_V1_DATA_MODEL_LIST
})
export const api_v1_data_model_listSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_LIST_SUCCEEDED,
  response
})
export const api_v1_data_model_listFailed = error => ({
  type: types.API_V1_DATA_MODEL_LIST_FAILED,
  error
})
export const api_v1_data_model_create = () => ({
  type: types.API_V1_DATA_MODEL_CREATE
})
export const api_v1_data_model_createSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_CREATE_SUCCEEDED,
  response
})
export const api_v1_data_model_createFailed = error => ({
  type: types.API_V1_DATA_MODEL_CREATE_FAILED,
  error
})
export const api_v1_data_model_read = () => ({
  type: types.API_V1_DATA_MODEL_READ
})
export const api_v1_data_model_readSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_READ_SUCCEEDED,
  response
})
export const api_v1_data_model_readFailed = error => ({
  type: types.API_V1_DATA_MODEL_READ_FAILED,
  error
})
export const api_v1_data_model_update = () => ({
  type: types.API_V1_DATA_MODEL_UPDATE
})
export const api_v1_data_model_updateSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_data_model_updateFailed = error => ({
  type: types.API_V1_DATA_MODEL_UPDATE_FAILED,
  error
})
export const api_v1_data_model_partial_update = () => ({
  type: types.API_V1_DATA_MODEL_PARTIAL_UPDATE
})
export const api_v1_data_model_partial_updateSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_data_model_partial_updateFailed = error => ({
  type: types.API_V1_DATA_MODEL_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_data_model_delete = () => ({
  type: types.API_V1_DATA_MODEL_DELETE
})
export const api_v1_data_model_deleteSucceeded = response => ({
  type: types.API_V1_DATA_MODEL_DELETE_SUCCEEDED,
  response
})
export const api_v1_data_model_deleteFailed = error => ({
  type: types.API_V1_DATA_MODEL_DELETE_FAILED,
  error
})
