...
function* api_v1_data_model_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_data_model_list, action)
    yield put(actions.api_v1_data_model_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_listFailed(err))
  }
}
function* api_v1_data_model_listWatcher() {
  yield takeEvery(types.API_V1_DATA_MODEL_LIST, api_v1_data_model_listWorker)
}
function* api_v1_data_model_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_data_model_create, action)
    yield put(actions.api_v1_data_model_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_createFailed(err))
  }
}
function* api_v1_data_model_createWatcher() {
  yield takeEvery(
    types.API_V1_DATA_MODEL_CREATE,
    api_v1_data_model_createWorker
  )
}
function* api_v1_data_model_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_data_model_read, action)
    yield put(actions.api_v1_data_model_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_readFailed(err))
  }
}
function* api_v1_data_model_readWatcher() {
  yield takeEvery(types.API_V1_DATA_MODEL_READ, api_v1_data_model_readWorker)
}
function* api_v1_data_model_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_data_model_update, action)
    yield put(actions.api_v1_data_model_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_updateFailed(err))
  }
}
function* api_v1_data_model_updateWatcher() {
  yield takeEvery(
    types.API_V1_DATA_MODEL_UPDATE,
    api_v1_data_model_updateWorker
  )
}
function* api_v1_data_model_partial_updateWorker(action) {
  try {
    const result = yield call(
      apiService.api_v1_data_model_partial_update,
      action
    )
    yield put(actions.api_v1_data_model_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_partial_updateFailed(err))
  }
}
function* api_v1_data_model_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_DATA_MODEL_PARTIAL_UPDATE,
    api_v1_data_model_partial_updateWorker
  )
}
function* api_v1_data_model_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_data_model_delete, action)
    yield put(actions.api_v1_data_model_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_data_model_deleteFailed(err))
  }
}
function* api_v1_data_model_deleteWatcher() {
  yield takeEvery(
    types.API_V1_DATA_MODEL_DELETE,
    api_v1_data_model_deleteWorker
  )
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_data_model_listWatcher,
    api_v1_data_model_createWatcher,
    api_v1_data_model_readWatcher,
    api_v1_data_model_updateWatcher,
    api_v1_data_model_partial_updateWatcher,
    api_v1_data_model_deleteWatcher,
